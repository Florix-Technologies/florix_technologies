                ...
                <div className="relative flex w-full flex-col items-center justify-center overflow-hidden h-auto md:h-[500px]">
                    ...
                    <div className="max-w-6xl mx-auto text-center relative z-10 mt-4 md:mt-0">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6">
                            <Button asChild size="lg" className="w-full sm:w-auto rounded-full bg-primary hover:bg-primary/90 text-white px-8 py-3">
                ...
                <div className="relative">
                    {services.map((service, index) => {
                        ...
                        return (
                            <motion.div
                                key={index}
                                className="sticky flex items-center justify-center px-6 py-4 md:py-6 min-h-[50vh]"
                                style={{
                                    top: `${160 + index * 20}px`, // Increased stack spacing
                                }}
                                initial={{ opacity: 0, y: 50, scale: 0.95 }} // Reduced distance, added scale
                                whileInView={{ opacity: 1, y: 0, scale: 1 }}
                                transition={{
                                    type: "spring",
                                    stiffness: 200, // Much snappier (was 80)
                                    damping: 25, // No oscillation
                                    mass: 0.5 // Very light weight
                                }}
                                viewport={{ once: true, margin: "-10%" }} // Trigger normally
                            >
                                <div className="w-full max-w-lg mx-auto">
                                    <Card
                                        className={`p-6 md:p-8 relative overflow-hidden group cursor-pointer
                    ...
                    transition-all duration-500 rounded-3xl`}
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-5 md:gap-6">
                                            {/* Icon with glow */}
                                            <motion.div
                                                className="flex-shrink-0 p-4 md:p-5 rounded-3xl bg-primary/10 group-hover:bg-primary/20 transition-all duration-500"
                                                whileHover={{ scale: 1.1, rotate: 5 }}
                                                transition={{ duration: 0.3 }}
                                            >
                                                <Icon className="w-10 h-10 md:w-14 md:h-14 text-primary group-hover:drop-shadow-[0_0_20px_rgba(34,197,94,0.9)] transition-all duration-500" />
                                            </motion.div>

                                            {/* Text content */}
                                            <div className="flex-1">
                                                <h3 className="text-xl md:text-2xl font-bold mb-2 md:mb-3 text-foreground group-hover:text-primary transition-colors duration-300">
                                                    {service.title}
                                                </h3>
